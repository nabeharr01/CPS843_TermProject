...
# Dense Model
dense_model = keras.models.load_model("mp-landmarks-to-asl-nn.keras")
dense_predictor = Predictor(dense_model, "landmark_label_classes.npy")
# CNN Model
cnn_model = keras.models.load_model("mp-to-asl-cnn-model.keras")
cnn_predictor = Predictor(cnn_model, "label_classes.npy")
